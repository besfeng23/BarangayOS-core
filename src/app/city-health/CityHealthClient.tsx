...
export default function CityHealthClient() {
      ...
      <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4 mb-6">
          ...
          <div className="relative mt-2">
            <input
              placeholder="Ask: Show children missing vaccines"
              className="bg-slate-900 border-slate-600 text-white pl-4 pr-28 h-12 w-full rounded-md"
            />
          ...
          <div className="flex gap-2 mt-2">
            <Badge variant="secondary" className="cursor-pointer">
              TB patients with missed DOTS
            </Badge>
            <Badge variant="secondary" className="cursor-pointer">
              Pregnant mothers due for checkup
            </Badge>
            <Badge variant="secondary" className="cursor-pointer">
              Senior citizens needing BP monitoring
            </Badge>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          <Link href="/city-health/queue" passHref>
            <Button variant="outline">Today's Queue</Button>
          </Link>
          <Link href="/city-health/patients" passHref>
            <Button variant="outline">Patients</Button>
          </Link>
          <Link href="/city-health/reports" passHref>
            <Button variant="outline">Reports</Button>
          </Link>
          <Link href="/city-health/medicines" passHref>
            <Button variant="outline">Medicines</Button>
          </Link>
          <Link href="/city-health/programs" passHref>
            <Button variant="outline">Programs</Button>
          </Link>
          <Link href="/city-health/alerts" passHref>
            <Button variant="outline">Alerts & Follow-ups</Button>
          </Link>
          <Link href="/city-health/settings" passHref>
