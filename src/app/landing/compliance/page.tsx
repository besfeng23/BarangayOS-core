        ...
        <div className="prose prose-sm md:prose-base prose-invert max-w-none">
            ...
            <div className="my-8 grid gap-6">
                <div className="bg-card border border-primary/20 p-6 rounded-xl">
                    <h3 className="text-primary font-bold text-lg">R.A. 11032 — Ease of Doing Business Act</h3>
                ...
                <div className="bg-card border p-6 rounded-xl">
                    <h3 className="text-card-foreground font-bold text-lg">DILG MC No. 2008-144 — RBIA Maintenance</h3>
                    <p className="text-sm text-muted-foreground mt-2">
                ...
                <div className="bg-card border p-6 rounded-xl">
                    <h3 className="text-card-foreground font-bold text-lg">P.D. 1508 — Katarungang Pambarangay Law</h3>
                    <p className="text-sm text-muted-foreground mt-2">
