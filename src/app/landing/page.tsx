            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <div className="relative mx-auto max-w-5xl">
                    ...
                    <div className="relative rounded-xl border border-white/10 bg-gray-900 shadow-2xl overflow-hidden">
                        <Image src="/landing/dashboard_preview.png" alt="BarangayOS Dashboard Interface" width={1024} height={576} className="w-full h-auto opacity-90"/>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
                ...
                <div className="flex gap-6">
                    ...
                    <a href="#" className="hover:text-white">DILG Compliance</a>
                </div>
            </div>
        </div>
      </footer>
